...
func mergeEntity(selected, other proto.Message, selectedPeer, otherPeer string) {
	...
	case *bgplsv1.Link:
		...
		mergeString("local_ipv4_address", &a.LocalIpv4Address, b.LocalIpv4Address, a.Meta, selectedPeer, otherPeer)
		mergeString("remote_ipv4_address", &a.RemoteIpv4Address, b.RemoteIpv4Address, a.Meta, selectedPeer, otherPeer)
		mergeString("local_ipv6_address", &a.LocalIpv6Address, b.LocalIpv6Address, a.Meta, selectedPeer, otherPeer)
		mergeString("remote_ipv6_address", &a.RemoteIpv6Address, b.RemoteIpv6Address, a.Meta, selectedPeer, otherPeer)
